...
from torch.distributed.checkpoint import FileSystemWriter, FileSystemReader, load_state_dict, save_state_dict
    ...
    def fsdp_save_ckpt(
        ...
        with FSDP.state_dict_type(model, StateDictType.LOCAL_STATE_DICT):
            if fsdp_config.sharding_strategy == "FULL_SHARD":
                ...
                print(f"shard_index: {shard_index}, total_shards: {total_shards}")
